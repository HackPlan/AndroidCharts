...
//            pieHelperArrayList.add(new PieHelper());
        }
    ...
    private void set(PieView pieView){
        ArrayList<PieHelper> pieHelperArrayList = new ArrayList<PieHelper>();
        pieHelperArrayList.add(new PieHelper(0, 99, "20%"));
        pieHelperArrayList.add(new PieHelper(99, 166, "80"));
        pieHelperArrayList.add(new PieHelper(166, 233,"sth"));
        pieHelperArrayList.add(new PieHelper(233, 270,"we2"));
        pieHelperArrayList.add(new PieHelper(270, 360,"232"));

//        pieHelperArrayList.add(new PieHelper(360, 510));
        pieView.setDate(pieHelperArrayList);
